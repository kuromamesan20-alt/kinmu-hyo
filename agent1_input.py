...
SHIFT_HOURS = {
    "早": 8, "日": 8, "A": 4, "P": 4,
    "準": 8, "深": 8, "夕": 4, "朝夕": 4, "送迎": 4,
    "相": 8, "事務": 8, "計": 8, "寺": 8, "皿洗い": 4, "休": 0, "": 0
}
...
# 認知症加算対象（日勤必須メンバー）
NINCHI_STAFF = {"出野聡子", "谷口直子", "稲継大稀", "坂本雅代"}

# 看護師（中重度加算）
NURSE_STAFF = {"石橋泉子", "川野藍", "工藤泉", "曽我久美子", "中嶋桜月", "石田美歩", "佐々木優奈"}
...
WEEKLY_2REST_STAFF = {
    ...
    "稲継大稀", "岡田健吾", "岡谷佳代子", "佐々木優奈"
}

# A・P禁止スタッフ（明示）
AP_FORBIDDEN = {
    "出野聡子", "大久保夏南", "坂本雅代", "安部稚畝",
    "稲継大稀", "岡田健吾", "岡谷佳代子", "中嶋桜月"
}
